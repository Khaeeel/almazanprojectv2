export const config = {
    ...
    projects: [
        ...
        },
        {
            ...
            technologies: "Python, Pandas, NumPy, scikit-learn, Matplotlib, Seaborn, Data Preprocessing, Feature Scaling, SMOTE (Class Balancing), K-Fold Cross Validation, Hyperparameter Tuning, Classification Modeling, Model Evaluation (ROC-AUC, Precision-Recall, Confusion Matrix), Learning Curve Analysis",
        ...
        },
        {
            ...
            technologies: "Python, Hugging Face Transformers, PyTorch, Pandas, NumPy, Weights & Biases, NLP Preprocessing, Transformer Fine-Tuning (MentalBERT), Tokenization, Hyperparameter Optimization (Grid Search, Random Search), Model Evaluation (Accuracy, Precision, Recall, F1-score)",
        ...
        },
        {
            ...
            category: "NLP",
            technologies: "Python, spaCy, Pandas, NumPy, NLP Preprocessing, Tokenization, Text Cleaning, Sentiment Classification (Positive/Negative), Hyperparameter Tuning, Model Evaluation (Accuracy, Precision, Recall, F1-score)",
